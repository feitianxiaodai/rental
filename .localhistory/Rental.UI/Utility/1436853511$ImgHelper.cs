...
namespace Rental.UI.Utility
{
    ...
    {
        public static void GenerateThumbImg(string originImgUrl, int width, int height, string desImgUrl)
        {
            string newFileName = string.Empty;
            if (!File.Exists(originImgUrl))
            {
                return;
            }
            Bitmap originalBmp = null;
            var originImage = Image.FromFile(originImgUrl);
